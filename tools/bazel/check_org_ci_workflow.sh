...
require_text "bazel test //:org_ci_workflow //:submodule_status" "$workflow"
...
require_text "@bazel/bazelisk@1.28.1" "$workflow"
require_text "bazel fetch //:org" "$workflow"
require_text "bazel test //:org" "$workflow"
