...
| 21 | Guard/eliminate the `assumeIsolated` antipattern via one reusable checked-access helper | High | M | Low | 🟡 in progress · helper + 3 site-groups `247e4dc3` |
